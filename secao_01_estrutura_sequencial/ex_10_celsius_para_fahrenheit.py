...
def transformar_para_fahrenheit():
    ...
    import math
    celsius = int(input("Digite a temperatura em celsius que você quer transformar: "))
    fahreheit = math.ceil(celsius * 1.8) + 32
    print(f"Essa temperatura é de {fahreheit} Fahrenheit")
