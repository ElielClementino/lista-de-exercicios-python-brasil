...
def converter_metros_para_centimetros():
    ...
    metros = float(input("Digite quantos metros você deseja passar para centímetros: "))
    centimetros = 100;
    soma = metros * centimetros
    print("Transformando para centímetros dá {} cm".format(soma))
